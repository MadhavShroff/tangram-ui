...
const LogoAnimated = () => {
    return (
        <div className="flex flex-row items-center gap-2 h-16 overflow-hidden">
            <span className="text-2xl">tangram.ai</span>
            <div className="h-16 mb-2 pt-2">
                <TangramAnimation scale={0.4} />
            </div>
        </div>
    );
}
                                ...
                                <div className="relative h-24 overflow-hidden">
                                    <div className="absolute whitespace-nowrap animate-scroll-left">
                                        {modulesRow2.map((module, index) => (
                                            <div key={index} className={`inline-block w-46 h-20 ${module.color} m-2 p-2 rounded text-white flex items-center justify-center`} >
                                                {module.name}
                                            </div>
                                        ))}
                                    </div>
