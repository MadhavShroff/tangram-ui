...
export function isMessageVersion(obj: MessageVersion): obj is MessageVersion {
  if (!obj)
...
export function areMessages(objs: Message[]): objs is Message[] {
  if (!objs) {
  ...
  for (const obj of objs) {
    if (!isMessage(obj)) {
      console.log(
        "areMessages Failure: One of the objs is not of type Message."
      );
      return false;
    }
  }
...
export const isMessageVersionArray = (
  versions: MessageVersion[]
): versions is MessageVersion[] => {
